...
public class TypePriorities {
    ...
    public static String dbPediaOrganizationPriorities[] = { "country", "ethnicGroup", "country-1", "nationality-1",
            ...
            "goldenGlobeAward", "highschool", "incumbent", "industry", "keyPerson", "lastRace", "lastWin", "league",
            "mainInterest", "majorShrine", "mission", "movement", "nominee", "notableIdea", "notableStudent",
            "notableStudent-1", "notableWork", "olivierAward", "opponent", "opponent-1", "owner", "owningCompany",
            "parentCompany", "partner", "partner-1", "personFunction", "philosophicalSchool", "placeOfBurial",
            "product", "prospectTeam", "regionServed", "relation-1", "relative", "relative-1", "restingPlace",
            "restingPlacePosition", "royalAnthem", "runningMate", "school", "selection", "significantBuilding",
            "significantProject", "tonyAward", "trainer", "trainer-1", "training", "university", "veneratedIn",
            "winsAtAsia", "winsAtAus", "winsAtJapan", "winsAtMajors", "winsAtOtherTournaments", "winsAtPGA",
            "winsInEurope", "academicDiscipline", "affiliation", "aircraftAttack", "aircraftBomber",
            "aircraftElectronic", "aircraftFighter", "aircraftHelicopter", "aircraftInterceptor", "aircraftPatrol",
            "aircraftRecon", "aircraftTrainer", "aircraftTransport", "album", "alliance", "architect", "architect-1",
            "architecturalStyle", "artist", "artist-1", "assembly", "associatedBand", "associatedBand-1",
            "associatedMusicalArtist", "associatedMusicalArtist-1", "associateEditor", "athletics", "athletics-1",
            "author", "author-1", "automobilePlatform", "award", "bandMember", "bandMember-1", "basedOn", "basedOn-1",
            "binomialAuthority", "birthPlace", "bodyStyle", "border", "broadcastArea", "broadcastNetwork",
            "broadcastNetwork-1", "builder", "campus", "capital-1", "capitalMountain", "capitalPlace",
            "capitalPosition", "capitalRegion", "ceo", "ceremonialCounty-1", "chairman", "chairperson", "channel",
            "chiefEditor", "child", "childOrganisation", "childOrganisation-1", "cinematography", "city", "class",
            "clubsRecordGoalscorer", "colour", "commander", "commandStructure", "company", "composer",
            "computingInput", "computingMedia", "computingPlatform", "constructionMaterial", "county-1",
            "creativeDirector", "creator", "creator-1", "crosses", "currency-1", "daylightSavingTimeZone", "dean",
            "department", "designCompany", "designer", "destination", "developer", "discoverer", "distributingCompany",
            "distributingLabel", "distributor", "district", "division", "division-1", "editing", "editor", "editor-1",
            "endingTheme", "engine", "engineer", "engineType", "equipment", "ethnicGroup-1", "europeanAffiliation",
            "europeanAffiliation-1", "europeanParliamentGroup", "executiveProducer", "family", "federalState",
            "firstAppearance", "format", "formerBandMember", "formerBandMember-1", "formerBroadcastNetwork",
            "formerBroadcastNetwork-1", "foundedBy", "foundedBy-1", "foundingPerson", "fourthCommander", "frazioni",
            "gameEngine", "generalManager", "genre", "genus", "governingBody", "governingBody-1", "governmentCountry",
            "governmentPosition", "governmentRegion", "grades", "ground", "head", "headquarter", "headquarters",
            "highestPlace", "highestPosition", "highestRegion", "homeStadium", "homeStadium-1", "hometown", "honours",
            "hubAirport", "ideology", "ideology-1", "influenced", "influencedBy", "instrument", "instrument-1",
            "internationalAffiliation", "internationalAffiliation-1", "isoCodeRegion", "isPartOf", "isPartOf-1",
            "jurisdiction", "jurisdiction-1", "keyPerson-1", "kingdom", "largestCity-1", "largestSettlement",
            "largestSettlement-1", "lastAppearance", "launchSite", "launchSite-1", "layout", "leader",
            "leaderFunction", "leaderName-1", "leaderParty", "leaderParty-1", "license", "license-1", "literaryGenre",
            "locatedInArea", "locationCity", "locationCountry", "lounge", "lowestMountain", "lowestPlace", "lyrics",
            "mainOrgan", "maintainedBy", "managementPosition", "manager", "manufacturer", "manufacturer-1", "march",
            "mayor", "mediaType", "memberOfParliament", "memberOfParliament-1", "mergedIntoParty", "militaryBranch",
            "musicalArtist", "musicalArtist-1", "musicalBand", "musicalBand-1", "musicBy", "musicComposer",
            "nationalAffiliation", "nationalAffiliation-1", "nationality", "nearestCity", "nearestCity-1",
            "neighboringMunicipality", "network", "nonFictionSubject", "occupation", "openingTheme", "operatedBy",
            "operatedBy-1", "operatingSystem", "operatingSystem-1", "operator", "order", "origin",
            "owningOrganisation", "parentOrganisation", "part", "part-1", "patron", "person", "phylum", "picture",
            "pictureFormat", "politicalPartyInLegislature-1", "politicalPartyOfLeader-1", "portrayer", "powerType",
            "predecessor", "predecessor-1", "presenter", "president", "president-1", "previousEditor", "previousWork",
            "previousWork-1", "principal", "producer-1", "product-1", "programmeFormat", "programmingLanguage",
            "province", "provost", "publisher", "railwayRollingStock", "recordedIn", "recordLabel", "rector", "region",
            "relatedMeanOfTransportation", "relatedMeanOfTransportation-1", "religion", "residence", "resolution",
            "rival", "routeEnd", "routeEnd-1", "routeEndLocation", "routeJunction-1", "routeStart", "routeStart-1",
            "routeStartLocation", "saint", "schoolBoard", "secondCommander", "secretaryGeneral", "series", "service",
            "service-1", "servingRailwayLine", "showJudge", "similar", "sisterNewspaper", "sisterNewspaper-1",
            "sisterStation", "sisterStation-1", "species", "splitFromParty", "spokesperson", "sport", "sport-1",
            "spouse", "starring", "starring-1", "state", "stateOfOrigin", "storyEditor", "structuralSystem",
            "subsequentWork", "subsidiary", "successor", "successor-1", "targetAirport", "targetAirport-1", "team",
            "tenant", "tenant-1", "thirdCommander", "timeZone", "timeZone-1", "translator", "twinCity", "twinCity-1",
    ...
    public static String dbPediaPersonPriorities[] = { "type", "22-rdf-syntax-ns#type", "orderInOffice", "nationality",
            ...
            "religion", "spouse", "president-1", "notableCommander-1", "vicePresident", "president", "primeMinister",
            "award", "militaryRank", "child-1", "militaryCommand", "serviceStartYear", "office", "battle", "spouse-1",
